...
<head>
    <title>Zenith Group Invest Cryptocurrency</title>
        ...
        <div class="container">
            <div class="inner__banner__content text-center">
                ...
                <ul class="breadcums d-flex flex-wrap justify-content-center">
                    <li>we help you manage your cryptocurrency portfolio and help you grow them exponentially</li>
                </ul>
            </div>
        </div>
        <div class="shapes">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-10">
                    <div class="section__header ">
                        <h2 class="section__header-title">CRYPTOCURRENCIES</h2>
