                        ...
                        <div class="offset-lg-5 col-lg-7 col-12">
                            <div class="text-content-wrapper">
                                <div class="text-content text-center">
                                    ...
                                    <p>We have over 25 year’s of experience in Finance and Business management so we can
                                        make your business more successful you can trust us</p>
                                ...
                                <div id="five" class="collapse" role="tabpanel" aria-labelledby="headingFive"
                                    ...
                                    <div class="card-body">
                                        <p>The steps involved in this process are really simple. All you need to do is:
                                            ...
                                            activation email.Citigroup invest prohibits the creation of numerous
                                            accounts
...
<!-- Google Fonts -->
<link href="{{asset('assets/../../../fonts.googleapis.com/cssf77b.css?family=Poppins:400,600')}}" rel="stylesheet">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-3">
                    <span>Welcome to Citigroupinvest</span>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-12">
                    <div class="header-main-content">
                        <div class="header-info">
                            <img src="{{ asset('assets/img/icons/phone-2.png') }}" alt="">
                            <div class="header-info-text">
                                <h4>+1 510 288 2641</h4>
                                <span>We are open 24hrs</span>
                            </div>
                        </div>
                    </div>
                    <div class="logo-wrapper">
                        <div class="logo">
                            <a 
                            {{-- href="{{route('index')}}" --}}
                            ><img src="{{ asset('assets/img/logo/Citigroupinvest.png') }}"
                                    alt="FINANCO" width="110px" height="90px"/></a>
                        </div>
                    </div>
                    <div class="quote-btn">
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('services')}}">SERVICES</a>
                                    <ul class="submenu">
                                        ...
                                        <li><a href="{{route('escrow')}}">ESCROW SERVICES</a></li>
                                ...
                                <li><a href="{{route('investment_plans')}}">INVESTMENT PLANS </a>
                                    {{-- <ul class="submenu">
                        ...
                        <nav id="dropdown">
                            <ul>
                                ...
                                <li><a 
                                    ...
                                    <ul class="submenu">
                                        <li><a 
                                            {{-- href="{{route('cryptocurrency')}}" --}}
                                            >CRYPTOCURRENCY</a></li>
                                        <li><a 
                                            {{-- href="{{route('escrow')}}" --}}
                                            >ESCROW SERVICES</a></li>
                                        <li><a 
                                            {{-- href="{{route('stocks')}}" --}}
                                            >STOCKS</a></li>
                                        <li><a 
                                            {{-- href="{{route('real_estate')}}" --}}
                                            >REAL ESTATE</a></li>
                                        <li><a 
                                            {{-- href="{{route('forex')}}" --}}
                                            >FOREX</a></li>
