...
Route::get("/investment_plans",[UserController::class,"investment_plans"])->name("investment_plans");
Route::get("/real_estate",[UserController::class,"real_estate"])->name("real_estate");
